...
# datos_ejemplo.py
#datos de ejemplo para el sistema TechStore
...
productos = [
    ...
    {'id': 6, 'nombre': 'iPad Air M2', 'marca': 'Apple', 'categoria': 'Tablet', 'precio': 699.99, 'stock': 7, 'disponible': True},
...
empleados = [
    ...
    {'id': 105, 'nombre': 'Lucía', 'apellido': 'Ramos', 'departamento': 'Inventario', 'salario': 31000, 'activo': True}
]
